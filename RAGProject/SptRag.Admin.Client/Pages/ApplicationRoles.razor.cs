...
namespace SptRag.Admin.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<SptRag.Admin.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(SptRag.Admin.Server.Models.ApplicationRole role)
        {
            try
            {
