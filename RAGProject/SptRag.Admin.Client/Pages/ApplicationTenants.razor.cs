...
namespace SptRag.Admin.Client.Pages
{
    public partial class ApplicationTenants
    {
        ...
        protected IEnumerable<SptRag.Admin.Server.Models.ApplicationTenant> tenants;
        protected RadzenDataGrid<SptRag.Admin.Server.Models.ApplicationTenant> grid0;
        ...
        protected async Task SetDefaultTenant(MouseEventArgs args, SptRag.Admin.Server.Models.ApplicationTenant tenant)
        {
            Security.Tenant = tenant;
        }

        protected async Task RowSelect(SptRag.Admin.Server.Models.ApplicationTenant tenant)
        {
        ...
        protected async void RowRender(RowRenderEventArgs<SptRag.Admin.Server.Models.ApplicationTenant> args)
        {
            args.Attributes.Add("style", $"font-weight: {(args.Data.Id == Security.Tenant?.Id ? "bold" : "normal")};");
        }

        protected async Task DeleteClick(SptRag.Admin.Server.Models.ApplicationTenant tenant)
        {
            try
            {
