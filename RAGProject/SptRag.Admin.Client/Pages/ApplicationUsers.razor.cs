...
namespace SptRag.Admin.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<SptRag.Admin.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<SptRag.Admin.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(SptRag.Admin.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(SptRag.Admin.Server.Models.ApplicationUser user)
        {
            try
            {
